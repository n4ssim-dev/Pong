...
class Racket:
    ...
    def create_bot_racket(self):
        ...
        bot.shapesize(stretch_wid=6, stretch_len=1)
        bot.penup()
        bot.goto(self.bot_init_position)
        self.rackets.append(bot)

    def bot_move_up(self):
        self.rackets[1].shapesize(stretch_wid=1, stretch_len=6)
    ...
    def create_player_racket(self):
        ...
        racket.shapesize(stretch_wid=6, stretch_len=1)
        racket.penup()
        racket.goto(self.player_init_position)
        self.rackets.append(racket)

    def move_up(self):
        if self.rackets[0].ycor() < 430:
            self.rackets[0].shapesize(stretch_wid=1, stretch_len=6)
