...
class Racket:
    def __init__(self):
        ...
        self.player_init_position = (-770,0)
        self.bot_init_position = (770,0)
        self.rackets = []
    ...
    def create_bot_racket(self):
        ...
        bot.shapesize(stretch_wid=10, stretch_len=1)
        bot.penup()
        bot.goto(self.bot_init_position)
        self.rackets.append(bot)

    def bot_move_up(self):
        self.rackets[1].shapesize(stretch_wid=1, stretch_len=10)
        self.rackets[1].setheading(90)
        self.rackets[1].forward(3)
    ...
    def create_player_racket(self):
        ...
        racket.shapesize(stretch_wid=10, stretch_len=1)
        racket.penup()
        racket.goto(self.player_init_position)
        self.rackets.append(racket)

    def move_up(self):
        if self.rackets[0].ycor() < 400:
            self.rackets[0].shapesize(stretch_wid=1, stretch_len=10)
            self.rackets[0].setheading(90)
            self.rackets[0].forward(20)
