...
class Racket:
    ...
    def bot_move_up(self):
        ...
        self.rackets[1].shapesize(stretch_wid=0.5, stretch_len=5)
        self.rackets[1].forward(self.bot_speed)
    ...
    def create_player_racket(self):
        ...
        racket.shapesize(stretch_wid=5, stretch_len=0.5)
        racket.penup()
    ...
    def move_up(self):
        if self.rackets[0].ycor() < 200:
            ...
            self.rackets[0].shapesize(stretch_wid=0.5, stretch_len=5)
